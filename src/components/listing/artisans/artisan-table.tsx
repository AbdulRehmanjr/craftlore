...
const columns: ColumnDef<ArtisanProps>[] = [
    ...
    },
    {
        ...
        filterFn: "includesString",
        cell: ({ row }) => (
            <div className="text-gray-600">{row.getValue("address")}</div>
        ),
    },
    {
        ...
        header: "Skill Level",
        cell: ({ row }) => (
            <div className="font-medium">{row.getValue("craftSkill")}</div>
        ),
    },
    {
        ...
        header: "Specialty",
        cell: ({ row }) => (
            <div className="text-gray-600">{row.getValue("craftSpecialty")}</div>
        ),
    },
    {
