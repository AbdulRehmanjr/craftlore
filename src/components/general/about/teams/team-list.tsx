            ...
            >
              <div className="space-y-4">
                <div className="pb-3">
                  ...
                  <p className="font-opensans text-gray-500 group-hover:text-white mt-3">
                    <span className="font-bold text-gray-950 mr-1 group-hover:text-white">Deputed Organization :</span>{employ.organization}
                  </p>
                </div>
