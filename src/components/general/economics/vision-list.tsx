...
export const VisionList = ()=>{
    const icons: LucideIcon[] = [
        LineChart,    // Track economic trends
        Factory,      // Monitor production
        AlertCircle,  // Identify vulnerabilities
        Lightbulb,    // Providing insights
        Leaf,         // Sustainable practices
        Eye          // Enhancing transparency
    ]

    return(
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {
                PURPOSEVISION.map((vision,index)=>{
