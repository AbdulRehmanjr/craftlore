...
export default function EmploymentPage() {
  return (
    <SectionContainer className="my-12 mb-32 grid gap-12">
      ...
      <p className="font-opensans text-xl leading-[31px]">
        ...
        comprehensive overview of employment dynamics, helping artisans,
        businesses, and policymakers make informed decisions that promote job
        growth, improve working conditions, and ensure sustainable livelihoods
      ...
      <p className="font-opensans text-xl leading-[31px]">
        The core mission of the Kashmir Handicrafts Employment Monitoring Center
        is to provide comprehensive insights into the labor dynamics of the
        handicraft sector, aiming to:
      </p>
      ...
      <div className="grid gap-4 rounded-lg bg-white px-8 py-12 shadow-md">
        ...
        <p className="font-opensans text-xl">
          ...
          generations, and the impact of globalization on artisan employment. By
          offering real-time insights and predictive analytics, the center
          ensures that Kashmiri artisans can thrive in both local and global
          markets, creating a sustainable workforce for future generations.
        </p>
        <p className="font-opensans text-xl">
          Through its focus on employment monitoring, the center safeguards the
          future of Kashmiri craftsmanship while promoting ethical labor
