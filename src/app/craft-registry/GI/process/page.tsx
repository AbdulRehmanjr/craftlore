...
export default function GIProcessPage() {
  return (
    <SectionContainer className="my-10 grid gap-10">
      ...
      <p className="font-opensans text-xl">
        The Geographical Indication (GI) Process is a stringent and multifaceted
        certification designed to authenticate crafts that originate from a
        specific geographical region and carry with them centuries of tradition.
        For Kashmiri crafts to receive GI status, they must meet specific
        criteria, including:
      </p>
      <p className="font-opensans text-xl">
        <strong>Traditional Techniques</strong>: Hand-woven Pashmina, intricate
        Papier-Mâché, Khatamband woodwork, etc.
        <br />
        ...
        Kashmir. <br />
        <strong>Geographical Origin</strong>: The product must originate within
        the geographical boundaries of Kashmir to be eligible for GI status.
      </p>
      <p className="font-opensans text-xl">
        ...
        crafts, this certification acts as a protective mechanism that not only
        preserves the cultural and geographical heritage but also ensures that
        these crafts receive global recognition and protection against
        counterfeiting. Below is a step-by-step breakdown of the GI
