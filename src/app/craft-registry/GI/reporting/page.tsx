        ...
        <div className="col-span-2 flex flex-col gap-6 p-4 lg:col-span-1">
          ...
          <div className="space-y-6 [&_h3]:font-montserrat [&_h3]:text-3xl [&_h3]:text-gray-950 [&_p]:font-opensans [&_p]:text-xl">
            ...
            <p>
              ...
              bodies. By bridging the gap between consumers and the GI
              enforcement authorities, the consumer reporting mechanism enhances
              trust and fortifies the GI certification process.
            </p>
            <h3>Ensure the following steps before filing a report: </h3>
            <p>
              Double-check the <strong>8-digit GI ID</strong> on the product or
              certification.
            </p>
            <p>
